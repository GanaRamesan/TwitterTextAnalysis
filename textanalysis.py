...
def mostUsers():
    INPUTFILE = input("MOST USERS ::: Enter the file path: ")
    ...
    outputFile = open('C:/Users/ganar/PycharmProjects/twitter/MostUsers.txt', 'w', encoding="utf-8")
...
def mostUsersPerHour():
    INPUTFILE = input("MOST USERS PER HOUR ::: Enter the file path: ")
    INPUT_FILE_PATH = INPUTFILE + '.txt'
    ...
    outputFile = open('C:/Users/ganar/PycharmProjects/twitter/MostUsersPerHour.txt', 'w',
                      encoding='utf-8')
...
def maxFollowers():
    INPUTFILE = input("MAX FOLLOWERS ::: Enter the file path: ")
    INPUT_FILE_PATH = INPUTFILE + '.txt'
    ...
    l = sorted(l.items(), key=operator.itemgetter(1), reverse=True)
    outputFile = open('C:/Users/ganar/PycharmProjects/twitter/MaxFollowers.txt', 'w',
                      encoding="utf-8")
...
def maxRetweet():
    INPUTFILE = input("MAX RETWEETS ::: Enter the file path:  ")
    INPUT_FILE_PATH = INPUTFILE + '.txt'
    ...
    outputFile = open('C:/Users/ganar/PycharmProjects/twitter/MaxRetweets.txt', 'w', encoding="utf-8")
    l = sorted(l.items(), key=operator.itemgetter(1), reverse=True)
